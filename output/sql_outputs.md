...
**Output** (12 rows, executed in 11.42 ms):
...
**Output** (12 rows, executed in 5.33 ms):
...
**Output** (6 rows, executed in 5.40 ms):
...
**Output** (1 row, executed in 3.43 ms):
...
**Output** (1 row, executed in 12.05 ms):
...
**Output** (24 rows, executed in 2.52 ms):
...
**Output** (5 rows, executed in 11.56 ms):
...
**Output** (1 row, executed in 9.74 ms):
...
**Output** (5 rows, executed in 14.78 ms):
...
**Output** (8 rows, executed in 34.59 ms):
...
**Output** (3 rows, executed in 21.54 ms):
