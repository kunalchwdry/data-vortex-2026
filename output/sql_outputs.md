...
**Output** (12 rows, executed in 10.52 ms):
...
**Output** (12 rows, executed in 11.32 ms):
...
**Output** (6 rows, executed in 9.49 ms):
...
**Output** (1 row, executed in 6.59 ms):
...
**Output** (1 row, executed in 10.17 ms):
...
**Output** (24 rows, executed in 4.81 ms):
...
**Output** (5 rows, executed in 20.35 ms):
...
**Output** (1 row, executed in 16.00 ms):
...
**Output** (5 rows, executed in 23.09 ms):
...
**Output** (8 rows, executed in 55.67 ms):
...
**Output** (3 rows, executed in 36.49 ms):
...
**Output** (5 rows, executed in 18.44 ms):
