...
src/               9 scripts: config, clean_data, eda, build_db, run_sql,
                   make_screenshots, build_report, make_notebook, verify_source
...
**Submission bundle** — Phase 1: `data/clean/Social_Engine_Posts_Clean.csv` +
`Social_Engine_Users_Clean.csv` (+ `.json`), `output/Phase1_EDA_Report.pdf`,
`notebooks/01_data_cleaning_eda.ipynb`, this repo.
